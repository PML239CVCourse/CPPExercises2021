...
void task2() {
    ...
    rassert(array2d.size() == 0,22869420);
    ...
    rassert(row1.size() == 3,22869420)
    rassert(array2d.size() == 2,22869420);
    std::cout << "print2DArray(array2d):" << std::endl;
    ...
    rassert(array2d.size() == 3,22869420);
    print2DArray(array2d);
}
...
void task3() {
    ...
    // TODO 32 попросите пользователя ввести два натуральных числа rows, cols (число рядов и число колонок) (от 1 до 20 включительно каждое)
        int rows,cols;
        cout << "Please enter number of rows and cols from 1 to 20";
        cin >> rows;
        cin >> cols;
    ...
    rassert(rows <=20,22869420);
    rassert(rows >=1,22869420);
    rassert(cols <=20,22869420);
    rassert(cols >=1,22869420);
    ...
    for(auto &h:array2d) h.resize(cols);
    print2DArray(array2d);
