...
void task2() {
    ...
    rassert(array2d.size() == 0, 53457656);
    ...
    rassert(row1.size() == 3, 734905);
    rassert(array2d.size() == 2, 7634805);
...
void task3() {
    ...
    int rows, cols;
    std::cout << "napishi pj kolichestvo snachala ryadov, a potom kolonok V PREDELACH OT 1 DO 20 :)" << std::endl;
    std::cin >> rows >> cols;
    ...
    rassert(rows < 21 && rows > 0, "chel ty..");
    rassert(cols < 21 && cols > 0, "chel ty...")
